...
public final class Flags {
    public static final int UPDATED = 1 << 0;
    public static final int NEAROPP = 1 << 1;
    ...
    public static final int NEARCENTER_2 = 1 << 6;
    public static final int NEARCENTER_3 = 1 << 7;

    public static final int NEARSELFCENTER_2 = 1 << 8;
    public static final int NEARSELFCENTER_3 = 1 << 9;
    ...
    public static final int BRING = 1 << 15;
}